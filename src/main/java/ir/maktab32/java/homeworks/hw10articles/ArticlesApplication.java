package ir.maktab32.java.homeworks.hw10articles;


import ir.maktab32.java.homeworks.hw10articles.entities.db1.Article;
import ir.maktab32.java.homeworks.hw10articles.features.articlemanagement.impl.*;
import ir.maktab32.java.homeworks.hw10articles.features.categorymanagement.impl.AddCategoryByAdminUseCaseImpl;
import ir.maktab32.java.homeworks.hw10articles.features.tagmanagement.impl.AddTagByAdminUseCaseImpl;
import ir.maktab32.java.homeworks.hw10articles.features.usermanagement.impl.*;
import ir.maktab32.java.homeworks.hw10articles.menu.CommandsMenu;
import ir.maktab32.java.homeworks.hw10articles.menu.DashboardMenu;
import ir.maktab32.java.homeworks.hw10articles.menu.SearchMenu;
import ir.maktab32.java.homeworks.hw10articles.utilities.Defaults;
...
public class ArticlesApplication {
    public static void main(String[] args) {
        ...
        while (!command.equals("exit")){
            ...
            else if (command.equals("all users")){
                List<UserInfo> userInfoList = new FindAllUsersInfoByAdminUseCaseImpl().execute();
