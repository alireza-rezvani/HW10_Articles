...
import ir.maktab32.java.homeworks.hw10articles.features.articlemanagement.usecase.AddArticleByWriterUseCase;
        ...
        if (!CurrentUserStatus.isSignedIn())
            ...
            if (category != null){
                result = new Article(null, title, brief, content, new Date(), null, null, false, tags,
                        AuthenticationService.getInstance().getSignedInUser().getUsername(), category);
            }
        }
        return result;
    }
